...
\begin{frame}[plain]
  ...
  \begin{textblock*}{3\TPHorizModule}(0mm,0mm)
    \includegraphics[height=\imageheight,width=\imagewidth]{furcifer-pardalis-nosy-faly-2}
    %\includegraphics[height=\imageheight,width=\imagewidth]{Cameleon_madagascar}
  \end{textblock*}
